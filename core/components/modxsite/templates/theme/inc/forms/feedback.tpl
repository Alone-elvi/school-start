...
<form class="form" id="ajax-contact-form" name="order_form" action="{link id=$modx->resource->id}?action=submit" method="post">
    <div class="panel panel-default">
        ...
        <div class="panel-footer">
            <input type="submit" class="btn btn-small" name="submit" value="Отправить" />
        </div>
    </div>
</form>
{else}
